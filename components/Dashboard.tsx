...
import { 
  ...
  Volume2, MessageCircle, Share2, Siren, Bed, Stethoscope, Pause, Check, Clipboard, CalendarClock, Send, Syringe, Thermometer, UserCheck, Trash2, CheckCircle, Pill, Filter, TestTube
} from 'lucide-react';
...
export const Dashboard: React.FC<DashboardProps> = ({ patients, userRole, orders = [], onCheckIn, onConsultPatient, showCodeBlue, setShowCodeBlue, language = 'en' }) => {
               ...
               <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                       ...
                       <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                           {admittedPatients.map(p => (
                               <div 
                                    ...
                                    className="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 flex flex-col gap-2 hover:shadow-lg hover:border-blue-300 dark:hover:border-blue-700 hover:-translate-y-1 transition-all duration-200 cursor-pointer active:scale-95 group"
                                >
                                   <div className="flex justify-between items-start">
                                       <div className="flex items-center gap-3">
                                            <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center font-bold text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform">
                                                {p.name.charAt(0)}
                                            </div>
                                            <div>
                                                <h4 className="font-bold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{p.name}</h4>
                                   ...
                                   <div className="mt-2 grid grid-cols-2 gap-2 text-sm">
                                       <div className="bg-slate-50 dark:bg-slate-700/50 p-2 rounded group-hover:bg-blue-50 dark:group-hover:bg-slate-700 transition-colors">
                   ...
                   <div className="space-y-6">
                       ...
                       <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6 h-fit shadow-sm hover:shadow-md transition-shadow">
                           ...
                           <div className="space-y-3 max-h-[300px] overflow-y-auto scroll-smooth custom-scrollbar">
                               {orders.length === 0 ? (
                                   <p className="text-sm text-slate-400 italic">No pending orders.</p>
                               ) : (
                                   orders.map(order => (
                                       <div key={order.id} className="p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg border border-indigo-100 dark:border-indigo-800/50 hover:bg-indigo-100 dark:hover:bg-indigo-900/40 transition-colors cursor-pointer">
                       ...
                       <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6 h-fit shadow-sm hover:shadow-md transition-shadow">
                           ...
                           <div className="space-y-3">
                               {[
                                   ...
                                   <div key={task.id} className="flex items-center gap-3 p-3 bg-slate-50 dark:bg-slate-900/50 rounded-lg border border-slate-100 dark:border-slate-700 hover:bg-white dark:hover:bg-slate-800 hover:shadow-sm cursor-pointer transition-all duration-200 active:scale-95 group">
  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-6 pb-6 animate-fade-in relative">
      ...
      <div className="bg-amber-50 dark:bg-amber-900/20 border-l-4 border-amber-500 p-4 rounded-r-lg flex justify-between items-center animate-slide-in shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center gap-3">
          ...
          <button className="text-xs font-bold bg-white dark:bg-slate-800 px-3 py-1.5 rounded-md border border-amber-200 dark:border-amber-800 text-amber-700 dark:text-amber-400 hover:bg-amber-50 dark:hover:bg-amber-900/30 transition-colors">
              Edit Notice
          </button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-center justify-between transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-blue-300 dark:hover:border-blue-700 cursor-pointer active:scale-95 group">
           <div>
           ...
           <div className="w-14 h-14 bg-blue-50 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center text-blue-600 dark:text-blue-400 group-hover:scale-110 transition-transform shadow-sm group-hover:shadow-md">
              <Users size={28} />
           </div>
        </div>

        <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-center justify-between transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-red-300 dark:hover:border-red-800/50 cursor-pointer active:scale-95 group">
           <div>
           ...
           <div className="w-14 h-14 bg-red-50 dark:bg-red-900/30 rounded-2xl flex items-center justify-center text-red-600 dark:text-red-400 group-hover:scale-110 transition-transform animate-pulse shadow-sm group-hover:shadow-md">
              <AlertCircle size={28} />
           </div>
        </div>

        <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-center justify-between transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-orange-300 dark:hover:border-orange-700 cursor-pointer active:scale-95 group">
           <div>
           ...
           <div className="w-14 h-14 bg-orange-50 dark:bg-orange-900/30 rounded-2xl flex items-center justify-center text-orange-500 group-hover:scale-110 transition-transform shadow-sm group-hover:shadow-md">
              <Clock size={28} />
           </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start h-auto">
          ...
          <div className="flex flex-col bg-slate-50 dark:bg-slate-800/20 rounded-2xl border border-slate-200 dark:border-slate-700 p-2 h-auto hover:border-slate-300 dark:hover:border-slate-600 transition-colors">
          ...
          <div className="flex flex-col bg-blue-50/50 dark:bg-blue-900/10 rounded-2xl border border-blue-100 dark:border-blue-800 p-2 h-auto hover:border-blue-200 dark:hover:border-blue-700 transition-colors">
      ...
      <div className="relative z-20 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm mt-8 animate-fade-in hover:shadow-md transition-shadow">
          <div className="flex justify-between items-center mb-4">
              <h3 className="font-bold text-slate-900 dark:text-white flex items-center gap-2">
                  <CalendarClock className="text-indigo-500" /> {t('followUpCenter')}
              </h3>
              <div className="flex gap-2">
                  <button className="text-xs font-bold text-slate-500 dark:text-slate-400 bg-slate-100 dark:bg-slate-700 px-3 py-1 rounded-full hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors active:scale-95">
                      {t('viewAll')}
                  </button>
              </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {followUpList.length > 0 ? followUpList.map(p => (
                  <div key={p.id} className="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/50 flex flex-col gap-3 hover:shadow-lg hover:-translate-y-1 transition-all duration-200 cursor-pointer">
                      ...
                      <div className="flex gap-2 mt-auto">
                          <button 
                              ...
                              className="flex-1 py-1.5 bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400 rounded-lg text-xs font-bold flex items-center justify-center gap-1 hover:bg-green-200 transition-colors active:scale-95"
                          >
                              <MessageCircle size={14} /> {t('remind')}
                          </button>
                          {p.followUp?.status === 'missed' && (
                              <button className="flex-1 py-1.5 bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400 rounded-lg text-xs font-bold flex items-center justify-center gap-1 hover:bg-red-200 transition-colors active:scale-95">
                  ...
                  <div className="pt-4 border-t border-slate-100 dark:border-slate-700">
                       ...
                       <div className="flex gap-3 overflow-x-auto pb-2 scroll-smooth custom-scrollbar">
                           {['Dr. Mehta', 'Dr. Rao', 'Dr. Iyer'].map((doc, i) => (
                               <div key={i} className="flex items-center gap-2 bg-slate-50 dark:bg-slate-900/50 px-3 py-1.5 rounded-full border border-slate-200 dark:border-slate-700 whitespace-nowrap">
                                   <div className="w-2 h-2 rounded-full bg-green-500"></div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="space-y-3">
                  {[
                      ...
                      <div key={i} className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-900/50 rounded-xl border border-slate-100 dark:border-slate-700 hover:bg-white dark:hover:bg-slate-800 hover:shadow-md transition-all cursor-pointer group active:scale-[0.98]">
                          <div className="flex items-center gap-3">
          ...
          >
            ...
            <div className="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div className="space-y-2 max-h-32 overflow-y-auto custom-scrollbar scroll-smooth">
...
const PatientCard: React.FC<{patient: Patient, setSelectedPatient: (p: Patient) => void}> = ({ patient, setSelectedPatient }) => {
    ...
    return (
        <div 
            ...
            className={`bg-white dark:bg-slate-800 p-4 rounded-xl border border-slate-200 dark:border-slate-700 border-l-4 ${borderColor} shadow-sm hover:shadow-lg hover:border-blue-400 dark:hover:border-blue-500 hover:-translate-y-1 transition-all duration-200 cursor-pointer active:scale-95 group`}
        >
